...
<img src="/blog/streamlining-chatgpt-experience-integrating-chatgpt-dmenu.png" alt="Streamlining your ChatGPT experience by integrating ChatGPT in dmenu">
...
<img src="/blog/chatgpt_rofi_script.png" alt="ChatGPT Rofi script">

- **Keyboard shortcut to launch chatgpt prompt**

  Replace {PATH*TO_SGPT_SCRIPT_FILE} with actual path in your system and add it to *~/.config/openbox/rc.xml\_.
  Reload the openbox configuration to changes to take effect.

    <img src="/blog/chatgpt_openbox_shortcut.png" alt="ChatGPT Openbox shortcut">
...
<img src="/blog/chatgpt_prompt.png" alt="ChatGPT prompt">

- Zenity progressbar

<img src="/blog/chatgpt_progress.png" alt="ChatGPT progress">

- Result

<img src="/blog/chatgpt_result.png" alt="ChatGPT result">
